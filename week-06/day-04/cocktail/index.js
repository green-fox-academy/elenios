...
app.get('/alcohol/:type', (req, res) => {
  const filteredList = cocktails.filter(drink => {
    return drink.contains.some(ingredient => ingredient === req.params.type);
  });
  res.render('home', {
    data: filteredList,
    filter: alcoholList,
    alcohol: req.params.type,
